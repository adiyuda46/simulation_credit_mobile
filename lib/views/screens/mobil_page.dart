...
import 'package:simulation_credit/views/cubits/var_mobil_cubit.dart';
...
class _MobilPageState extends State<MobilPage> {
  ...
  int? priceInInt;
  String typeProduct = "MOBIL";

  @override
  void initState() {
    super.initState();
    context.read<CatMobilCubit>().categoryMobil();
  }
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    BlocBuilder<CatMobilCubit, CatMobilState>(
                    ...
                    BlocBuilder<VarMobilCubit, VarMobilState>(
                      builder: (context, state) {
                        if (state.error != null) {
                          return Center(child: Text('Error: ${state.error}'));
                    ...
                    BlocBuilder<PriceMobilCubit, PriceMobilState>(
                      builder: (context, state) {
