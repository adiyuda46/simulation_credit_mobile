...
@injectable
class VarMotorBekasDataSource {
  final Dio _dio;

  VarMotorBekasDataSource()
      : _dio = Dio(
          BaseOptions(
  ...
  Future<VarianMotorBaruResp> varMotorBekas(String token, String category) async {
    try {
      final response = await _dio.post('/private/product/usedmotorcycle',
          data: {
